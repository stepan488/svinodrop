...
async function advanceNavalGames() {
  ...
  for (const game of games) {
    ...
    const shots = (human.shots as Array<{ x: number; y: number; hit: boolean; sunk?: boolean }>) || [];
