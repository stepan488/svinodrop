...
type NavalGame = { id: string; stake: number; status: string; turnUserId: string | null; turnEndsAt?: string | null; winnerUserId: string | null; mine: { ready: boolean; ships: { x: number; y: number }[]; shots: { x: number; y: number; hit: boolean; sunk?: boolean }[] }; opponent: { username: string; avatar: string | null; ready: boolean; bot?: boolean; shots: { x: number; y: number; hit: boolean; sunk?: boolean }[] } | null }
